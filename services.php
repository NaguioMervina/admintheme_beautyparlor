          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add" style="margin-left: 81%"><i class="fa fa-plus">Add</i>
                </button>
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Service Name.. ">
                                </div>
                              </div>
                                <div class="col-12">
                                <div class="form-group">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>hair-cutting</td>
                    <td><i style="">Haircutting (also hair shaping) - is the process of cutting, tapering, texturizing and thinning using any hair cutting</i></td>
                    <td><b style="color:blue">80.00</b></td>
                   ...
                   <tr>
                    <td>waxing and other forms of hair removal</td>
                    <td><i style="">Soft wax, also known as strip waxing, is used by spreading</i></td>
                    <td><b style="color:blue">39.00</b></td>
                    <td><button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil-alt"></i></button> <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>
                    </td>
                  </tr>
