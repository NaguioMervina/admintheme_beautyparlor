          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Billing Data table</h3> 
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="" placeholder="Enter Employee Address..">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Details</label>
                                  <input type="text" class="form-control" id="" placeholder="Enter Billing Details..">
                                </div>
                              </div>
                              </div>
                          </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>123</td>
                    <td><b style="color: blue">50.00</b></td>
                    <td>Renato Sabordo</td>
                    <td><i>10/10/20</i></td>
                    <td><a href="billingdetails.php"><button type="button" class="btn btn-primary btn-xs" >Data</button></a></td>
