      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="employee.php.php" class="nav-link active">
            ...
            <div class="card">
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Employee Code..">
                                </div>
                              </div>
                                <div class="col-7">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Employee Contact ..">
                                </div>
                              </div>
                                <div class="col-12">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Address</label>
                                  <input type="text" class="form-control" id="" placeholder="Enter Employee Address..">
                                </div>
                              </div>
                                <div class="col-12">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Email</label>
                                  <input type="text" class="form-control" id="" placeholder="Enter Employee Email">
                                </div>
                              </div>
                                <div class="col-4">
                                <div class="form-group">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <tr>
                    <td><img src="logo.png" alt="AdminLTE Logo" width="50" align="center" class="brand-image img-circle elevation-3" ></td>
                    <td><b style="color: orange">B12778-888</b></td>
                    <td>Jake Herviat</td>
                    <td>888-8888-888</td>
                    <td>Data-Street23</td>
                    <td><i style="color: blue"><u>lkikik@gmail.com</u></i></td>
